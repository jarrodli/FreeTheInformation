...
export const headerTextCss = "text-4xl font-inter font-semibold text-black";
...
export const formValues: Form[] = [
    ...
    },
    {
        ...
        options: [
            {
                formValue: "Australian drivers licence",
                displayValue: "Australian Drivers Licence",
            },
            {
                formValue: "Current Australian passport",
                displayValue: "Current Australian passport",
            },
            {
                formValue:
    ...
    },
    {
        ...
        caption:
            "Personal information is information about yourself or another individual. For more information, see here: https://www.ipc.nsw.gov.au/fact-sheet-public-officials-and-personal-information-under-gipa-act",
    ...
    },
    {
        displayValue: "",
        caption:
            "If you are requesting personal information about someone other than yourself, the Privacy and Personal Information Protection Act 1998 (NSW) applies. This may mean that your application will be denied unless it is of public interest.",
        formValue: "",
        type: "header",
    ...
    {
        displayValue:
            "Have you made an application for information at another agency requesting the same information? If yes, please enter the agency below.",
    ...
    },
    {
        ...
        options: [
            {
                formValue: "Inspect the documents",
                displayValue: "Inspect the documents",
            },
            {
                formValue: "A copy of the documents",
                displayValue: "A copy of the documents",
            },
            {
                formValue: "Access in another way please specify",
                displayValue: "Another way",
            },
        ],
    },
    {
        displayValue:
            "Please specify how you would like access to these documents",
        formValue: "Specify",
        type: "input",
        if: {
            formValue: "AccessMethod",
            type: "Access in another way please specify",
        },
    },
    {
        displayValue:
            "A $30 payment is required. How would you like to pay for this?",
    ...
    },
    {
        ...
        type: "dropdown",
        options: [
            { formValue: "Yes 3", displayValue: "Yes" },
            { formValue: "No 3", displayValue: "No" },
        ],
    },
    {
        displayValue:
            "Do you consent to this information being released on the Information and Privacy Commissioner's website?",
        caption:
            "Details about this application may be recorded and published on the Information and Privacy Commission website. You may object to this. For an example of what a disclosure log looks like, see: https://www.ipc.nsw.gov.au/sites/default/files/2022-03/IPC_Disclosure_Log_March%202022.pdf",
        formValue: "Disclosure Log",
        type: "dropdown",
        options: [
            { formValue: "Yes_disc", displayValue: "Yes" },
            { formValue: "No_disc", displayValue: "No" },
        ],
    }, // what does this map to?
    {
        displayValue: "Are you suffering from financial hardship?",
        caption:
            "If you are suffering financial, you may be entitled ot a 50% reduction in your processing charge ($30/hour). Please attach proof, such as your pensioners card or a Centrelink card.",
        formValue: "Financial Hardship",
        type: "dropdown",
        options: [
            { formValue: "Financial hardship", displayValue: "Yes" },
            { formValue: "", displayValue: "No" },
        ],
    },
    {
        displayValue:
    ...
    {
        displayValue:
            "Please specify what special benefit your application brings",
            ...
            switch (formEntry.type) {
                ...
                case "input": {
                    ...
                    if (
                        ...
                        values[formEntry.formValue]
                    ) {
                        pdfForm
                            .getCheckBox("Special benefit to the public")
                            .check();
                        pdfForm
                            .getTextField("Reason")
                            .setText(values[formEntry.formValue]);
                ...
                case "dropdown": {
                    ...
                    if (
                        formEntry.formValue === "Special benefit to the public"
                    ) {
                        if (values[formEntry.formValue] === "Other") {
                            ...
                            pdfForm
                                .getTextField("Reason")
                                .setText(values["benefit_specify"]);
    ...
    const completedFormText = () => {
        return (
            <p className={formTextCss}>
                ...
                attach any relevant payment information, and send it to the
                relevant agency.
            </p>
        );
    };
            ...
            <div>
                <div>
                    <h1 className={headerTextCss}>
                        Make an FOI request in New South Wales
                    </h1>
                </div>
                <div className="py-10 space-y-6">
                    <p className={"text-black"}>
                        Use this form if you want to make a Freedom of
                        Information (FOI) request in New South Wales under the
                        <i>
                            {" "}
                    ...
                    <p className={"text-black"}>
                        The agency has 20 working days to process your request.
