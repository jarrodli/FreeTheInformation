...
const formValues: Form[] = [
    ...
    {
        displayValue: 'Name and Address of agency who made the initial decision',
        formValue   : '1 Name and address of the agency who made the decision you are requesting an external review of',
        type        : 'input',
        validation  : 'agency', // TODO: autocomplete,
        caption     : ''
    },
    { displayValue: 'Full name', formValue: '2 Your full name', type: 'input' },
    { displayValue: 'Postal Address', formValue: '3 Your postal address', type: 'input' },
    { displayValue: 'Contact Number', formValue: '4 Telephone number', type: 'input' },
    { displayValue: 'Email', formValue: '5 Email address', type: 'input', validation: 'email' },
    {
    ...
    {
        displayValue: 'Are you filling out this application on the behalf of someone else?',
        caption     : 'Please attach a copy of your authority to act on their behalf',
    ...
    },
    {
        ...
        formValue   : '7 Important information If the application is on behalf of someone else please provide as an attachment a copy of your authority to act on their behalf 7 Their name and contact details below',
        type        : 'input',
        if          : { formValue: 'ignore_behalf', type: 'Yes' }
    },
    {
        displayValue: 'What is your relationship with this person?',
        formValue   : '8 What is your relationship to this person eg parent  friend  lawyer',
        type        : 'input',
        if          : { formValue: 'ignore_behalf', type: 'Yes' }
    },
    {
    ...
    },
    {
        ...
        formValue   : '10 If you formally applied for information what date did you apply to the agency',
        type        : 'input'
    },
    {
    ...
    {
        displayValue: 'Please provide details on how you received the agency\'s decision',
        formValue   : '13 If other, details',
        type        : 'input',
        if          : { formValue: 'how-receive', type: '13 Other' }
    },
    {
        displayValue: 'Are there any other documents relevant to this application?',
        formValue   : '14 Identify relevant documents',
        type        : 'input'
    },
    {
        displayValue: 'Have you applied to NSW Civil and Administrative Tribunal (NCAT) for internal review?',
    ...
    },
    {
        ...
        formValue   : '15 Have you sought an internal review by the agency or a review by the NSW Civil and Administrative Tribunal NCAT If yes please provide details Maximum 5000 Characters Note If you have sought a review by NCAT the IPC cannot review the same decision You must seek an internal review before coming to us unless you are the person who asked for the information Note If you have printed this form and are completing it by hand please write your extended response on a separate A4 page and attach to this form',
        type        : 'textarea',
        if          : { formValue: 'ignore_ncat', type: 'Yes' }
    },
    {
        displayValue: 'Why are you requesting an external review?',
        formValue   : '16 This section of the form will be removed and a copy provided to the Agency as part of the IPCs notification of an application for external review This is to assist the Agency in responding to the IPCs external review Please provide your reasons for requesting an external review Maximum 10000 Characters Note If you have printed this form and are completing it by hand please write your extended response on a separate A4 page and attach to this form',
        type        : 'textarea'
    },
    {
        displayValue: 'Do you consent for this application to be provided to the agency?',
        caption     : 'it will assist the Information Commissioner to have your consent for this section of your application to be provided to the agency so that the Commissioner can collect all of the information required to deal with your application',
        formValue   : 'consent',
        type        : 'dropdown',
        options     : [{ formValue: 'If you do not consent to the above please tick here', displayValue: 'Yes' }]
    },
    {
        displayValue: 'Do you wish to participate in a survey about your experience making this request?',
