...
const formValues: Form[] = [
    ...
    {
        displayValue:
            "Do you have authority to make an FOI request on the applicant's behalf? Please attach a copy of your authority to act.",
        formValue: "auth",
        type: "dropdown",
        options: [
    ...
    {
        displayValue:
            "Do you consent to us contacting third party agencies if necessary in processing your application?",
            ...
            <div>
                <div>
                    <h1 className={headerTextCss}>
                        Make an FOI request to a Commonwealth Agency
                    </h1>
                </div>
                <div className="py-10 space-y-6">
                    <p className={"text-black"}>
                        Use this form if you want to make a Freedom of
                        Information (FOI) request for a Commonwealth Agency
                        under the
                    ...
                    <p className={"text-black"}>
                        The agency has <b>30 days</b> to process your request.
                        ...
                        <a
                            className="transition duration-500 text-blue-500 hover:text-black hover:underline hover:decoration-2 hover:decoration-blue-500 hover:cursor-pointer"
                            href={"/cth/review"}
                        >
                            here
                        </a>
