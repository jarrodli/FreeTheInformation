...
const formValues: Form[] = [
    ...
    },
    {
        ...
        caption     : 'If you are making this request on behalf of an organisation or company, please provide their name here',
    ...
    },
    {
        ...
        type        : 'dropdown',
        options     : [
            { formValue: 'Inspect documents', displayValue: 'Inspect the documents' },
            { formValue: 'Photocopy of documents charges may apply', displayValue: 'A copy of the documents' },
            { formValue: 'Documents sent to me by email', displayValue: 'Documents sent to me via email' },
            { formValue: 'Copy of the documents on DVD', displayValue: 'A copy of the documents on a DVD' },
            { formValue: 'Copy of the documents on CD', displayValue: 'A copy of the documents on a CD' }
        ]
    }
]
...
const QldApplyForm: FunctionComponent<Props> = ({ data }) => {
    ...
    const completedFormText = () => {
        return <p className={formTextCss}>
            A completed FOI request form has been generated. Please sign it, attach any relevant payment
            information, and email it to the relevant agency.
        </p>
    }
